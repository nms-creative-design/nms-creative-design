                ...
                <Tab
                  ...
                  className={({ selected }) =>
                    selected
                      ...
                      : "bg-[#111111] text-white font-medium rounded-t-lg px-6 py-2 h-12 hover:bg-gray-700 hover:border-gray-600 transition-all duration-300"
                  }
                >
                  {label}
                </Tab>
