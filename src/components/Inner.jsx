...
const Inner = ({
  ...
  return (
    <section
      ref={containerRef}
      className={`relative w-full flex flex-col items-center justify-center overflow-hidden py-16 pt-32 ${sectionClassName}`}
    >
      {/* Background */}
      ...
      <div className="container mx-auto px-6 py-2 max-w-6xl z-10">
        ...
        >
          ...
          <div className="md:w-3/5">
            <h1
              className={`font-bold tracking-tight leading-tight fade-in-up ${titleClassName}`}
            >
            ...
            <p
              className={`text-gray-300 text-lg leading-relaxed fade-in-up ${descriptionClassName}`}
            >
              {description}
            </p>
          </div>
