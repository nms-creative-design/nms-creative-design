    ...
    <section className="bg-black py-24 w-full">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-8 mb-16">
          {/* 100+ Projects Card */}
          <Card className="flex-1 max-w-md bg-[#111111] border border-gray-800 rounded-lg text-center hover:border-gray-600 transition-all duration-300">
        ...
        <div className="text-center max-w-4xl mx-auto">
          <Typography className="text-gray-400 text-lg mb-8">
            At{" "}
            <span className="text-gray-300 font-medium">
              New Media Services - NMS Creative Design
            </span>{" "}
            we're not just a digital agency; we're the driving force behind your
            brand's digital transformation. What sets us apart is our unwavering
            commitment to pushing creative boundaries, our devotion to
            transforming ideas into results, and our profound understanding that
            your success is our success.
          </Typography>
          <Typography className="text-gray-400 text-lg">
            Our passionate team of web designers takes a unique approach to each
            project, fusing artistic finesse with data-driven strategies. We don't
            just build websites; we craft immersive digital experiences. We don't
            simply design; we create visual narratives that leave a lasting
            impact. We don't follow trends; we set new ones.
          </Typography>
        </div>
      </div>
    </section>
