    ...
    <section className="bg-black py-24 w-full">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="text-center mb-10">
          <h2 className="font-bold text-4xl bg-gradient-to-r from-gray-500 via-white to-gray-200 to-black text-transparent bg-clip-text">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-8 mb-16">
          {/* 100+ Projects */}
          <Card
            className="flex-1 max-w-md bg-white/5 border border-gray-700 rounded-lg text-center 
                       transition-all duration-300 relative overflow-hidden group backdrop-blur-md shadow-lg"
          >
...
<path d="M66.4923 86.7607L78.8422 99.5479C81.5297 102.331 82.8734 103.722 84.0114 104.203C86.6045 105.3 89.481 104.362 90.845 101.973C91.4436 100.924 91.6302 99.0337 92.0033 95.252C92.2139 93.117 92.3192 92.0493 92.6389 91.1552C93.3546 89.1534 94.8586 87.5962 96.7919 86.8552C97.6555 86.5241 98.6866 86.4151 100.749 86.197C104.401 85.8107 106.227 85.6176 107.24 84.9978C109.547 83.5854 110.453 80.6071 109.394 77.9222C108.929 76.7439 107.585 75.3526 104.898 72.57L97.4185 64.8261C91.2631 76.3666 79.9144 84.7181 66.4923 86.7607Z" fill="white"/>
              ...
              <Typography
                variant="h3"
                className="text-white text-6xl font-bold mb-2 transition-all duration-500 group-hover:text-shadow group-hover:scale-105"
              >
                100+
              </Typography>
              <Typography className="text-gray-300 text-lg transition-all duration-500 group-hover:text-white">
                Projects completed
              </Typography>
            </CardBody>
          </Card>
