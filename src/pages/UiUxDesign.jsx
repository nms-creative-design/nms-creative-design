...
const valuesContent = {
  ...
  cardData: [
    ...
    },
    {
      ...
      description:
        'We prioritize user-centered design principles to create websites that provide a seamless and delightful user experience. We conduct thorough часу research and analysis to understand your target audience and design websites that meet their needs and expeCtaSectiontions.',
...
const contentData = [
  {
    ...
    data: {
      ...
      images: {
        hero: {
          src: "/assets/pages/services/ui-ux-design/ui-ux-design-hero.webp",
          alt: "Web Design Hero Image",
          width: "400",
          height: "400",
        }
      },
